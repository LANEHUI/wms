...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (2, 3, '系统菜单', '/admin/menu', 'admin:menu:menu', 1, 'fa fa-th-list', 2, '2017-08-09 22:55:15', NULL);
INSERT INTO `sys_menu` VALUES (3, 0, '系统管理', NULL, NULL, 0, 'fa fa-desktop', 1, '2017-08-09 23:06:55','2017-08-14 14:13:43');
INSERT INTO `sys_menu` VALUES (6, 3, '用户管理', '/admin/user', 'admin:user:user', 1, 'fa fa-user', 0, '2017-08-10 00:00:00', NULL);
INSERT INTO `sys_menu` VALUES (7, 3, '角色管理', '/admin/role', 'admin:role:role', 1, 'fa fa-paw', 1, '2017-08-10 00:00:00', NULL);
INSERT INTO `sys_menu` VALUES (12, 6, '新增', '/api-admin/user', 'admin:user:add', 2, '', 0, '2017-08-14 00:00:00', NULL);
INSERT INTO `sys_menu` VALUES (13, 6, '编辑', '/api-admin/user', 'admin:user:edit', 2, '', 0, '2017-08-14 00:00:00', NULL);
INSERT INTO `sys_menu` VALUES (14, 6, '删除', '/api-admin/user', 'admin:user:remove', 2, NULL, 0, '2017-08-14 00:00:00', NULL);
INSERT INTO `sys_menu` VALUES (15, 7, '新增', '/api-admin/role', 'admin:role:add', 2, '', 0, '2017-08-14 00:00:00', NULL);
INSERT INTO `sys_menu` VALUES (20, 2, '新增', '/api-admin/menu', 'admin:menu:add', 2, '', 0, '2017-08-14 00:00:00', NULL);
INSERT INTO `sys_menu` VALUES (21, 2, '编辑', '/api-admin/menu', 'admin:menu:edit', 2, '', 0, '2017-08-14 00:00:00', NULL);
INSERT INTO `sys_menu` VALUES (22, 2, '删除', '/api-admin/menu', 'admin:menu:remove', 2, '', 0, '2017-08-14 00:00:00', NULL);
INSERT INTO `sys_menu` VALUES (25, 6, '停用', '/api-admin/user/disable', 'admin:user:disable', 2, NULL, 0, '2017-08-14 00:00:00', NULL);
INSERT INTO `sys_menu` VALUES (26, 6, '重置密码', '/api-admin/user/resetPwd', 'admin:user:resetPwd', 2, '', 0, '2017-08-14 00:00:00', NULL);
INSERT INTO `sys_menu` VALUES (55, 7, '编辑', '/api-admin/role', 'admin:role:edit', 2, '', NULL, NULL, NULL);
INSERT INTO `sys_menu` VALUES (56, 7, '删除', '/api-admin/role', 'admin:role:remove', 2, NULL, NULL, NULL, NULL);
INSERT INTO `sys_menu` VALUES (74, 73, '清除缓存', '/admin/api/menu/clearCache', 'system:sysDept:add', 1, NULL, 1, NULL, NULL);
INSERT INTO `sys_menu` VALUES (76, 73, '编辑', '/admin/api/user/currentUser', 'system:sysDept:edit', 2, NULL, 3, NULL, NULL);
INSERT INTO `sys_menu` VALUES (77, 2, '列表', '/api-admin/menu', 'admin:menu:list', 2, NULL, NULL, NULL, NULL);
INSERT INTO `sys_menu` VALUES (80, 79, '数据字典', '/a', NULL, 1, NULL, NULL, NULL, NULL);
INSERT INTO `sys_menu` VALUES (81, 78, '文件管理', '/cms/file', NULL, 1, NULL, NULL, NULL, NULL);
INSERT INTO `sys_menu` VALUES (82, 81, '列表', '/api-cms/file', 'cms:file', 2, NULL, NULL, NULL, NULL);
INSERT INTO `sys_menu` VALUES (87, 81, '上传', '/file/upload', NULL, 2, NULL, NULL, NULL, NULL);
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, '管理员角色','拥有最高权限');
INSERT INTO `sys_role` VALUES (56, '普通用户','');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '超级管理员', '33808479d49ca8a3cdc93d4f976d1e3d', 'admin@example.com', '2017-12-14 00:00:00');
