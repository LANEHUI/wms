  ...
  <el-row class="warp">
    <el-col :span="24" class="warp-breadcrum">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>水域编码数据</el-breadcrumb-item>
      </el-breadcrumb>
    </el-col>
    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
        <el-form role="form" :inline="true" size="small" id="projectForm" class="form-horizontal details">
          <el-row>
              <el-form-item label="水系编码:">
                <el-input size="mini" type="text" v-model="filters.code" clearable>
                </el-input>
              </el-form-item>
              <el-form-item label="水系:">
                <el-input size="mini" type="text" v-model="filters.name" clearable>
                </el-input>
              </el-form-item>
      ...
      <el-table :data="dataList" highlight-current-row @selection-change="selsChange" style="width: 100%;">
        ...
        <el-table-column prop="code" label="水系编码"></el-table-column>
        <el-table-column prop="name" label="水系"></el-table-column>
...
<script>
  ...
  import api from '@/api/apiWaterSystemCode';
