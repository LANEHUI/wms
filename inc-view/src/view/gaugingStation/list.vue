  ...
  <el-row class="warp">
    <el-col :span="24" class="warp-breadcrum">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>水位观测数据</el-breadcrumb-item>
      </el-breadcrumb>
    </el-col>
    ...
    <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
      ...
      <el-table :data="dataList" highlight-current-row @selection-change="selsChange" style="width: 100%;">
        ...
        <el-table-column prop="highestWaterLevel" label="实测最高水位"></el-table-column>
        <el-table-column prop="highestWaterTime" label="实测最高水位时间"></el-table-column>
        <el-table-column prop="lowWaterLevel" label="实测最低水位"></el-table-column>
        <el-table-column prop="lowWaterTime" label="实测最低水位时间"></el-table-column>
